    ...
    <div className="container mx-auto max-w-4xl px-4 py-8 md:px-0">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <section className="mt-8">
          ...
          <p>
            By accessing or using Zephyr ("the Platform"), you agree to be bound
        ...
        <section className="mt-8">
          ...
          <div className="space-y-4">
            ...
            <p>
              ...
              We use various third-party providers including but not limited to:
            </p>
            <ul className="list-disc space-y-2 pl-6">
        ...
        <section className="mt-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc space-y-2 pl-6">
              ...
              <li>
                You are responsible for your content and must have the right to
        ...
        <section className="mt-8">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-6">
            <li>Authentication providers (Google, GitHub, Discord, Twitter)</li>
        ...
        <section className="mt-8">
          ...
          <div className="space-y-4">
            <p>
              The Platform and its original content (excluding user content) are
              and will remain the property of Zephyr and its licensors.
            </p>
            <ul className="list-disc space-y-2 pl-6">
              <li>
        ...
        <section className="mt-8 rounded-lg bg-muted p-4">
          <p className="text-muted-foreground text-sm">
            By using Zephyr, you acknowledge that you have read, understood, and
